    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#262423]">
            <main className="flex-grow pb-24">
                {/* Hero Section */}
                <section className="relative overflow-hidden bg-gradient-to-br from-[#3B82F6]/5 via-[#262423] to-[#3B82F6]/5 py-20 border-b border-white/5 mb-20">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-24">
                        <div className="bg-[#2C2A29] p-8 rounded-2xl border border-white/5 hover:border-[#3B82F6]/50 transition-all hover:shadow-lg hover:-translate-y-1">
                    ...
                    {/* Story Section */}
                    <div className="max-w-4xl mx-auto bg-[#2C2A29]/50 rounded-3xl p-8 md:p-12 border border-white/5 mb-24">
                        <div className="flex flex-col md:flex-row gap-12 items-center">
                            <div className="flex-1">
                                <h2 className="text-3xl font-bold text-white mb-6">
                                    A História por Trás
                                </h2>
                                <div className="space-y-6 text-[#E8E8E6] leading-relaxed">
                                    <p>
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="flex justify-center gap-4">
                            ...
                            <Link href="/contato">
                                <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/5 text-lg h-12 px-8 font-semibold bg-transparent">
                                    Fale Conosco
                                </Button>
                            </Link>
                        </div>
